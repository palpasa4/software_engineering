...
LEFT JOIN user ON blog.author_id=user.user_id ORDER BY blog.publish_date DESC limit $offset,$limit";
				...
				<div class="card-body d-flex blog_flex">
					...
					<div class="flex-grow-1 flex-part2">
						...
						<p>
						  ...
						  <?= ucfirst(strip_tags(substr($result['blog_body'],0,200)))."<span class='text-primary'>...more</span>"?>
						  </a> <span><br>
